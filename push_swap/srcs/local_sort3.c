...
/*   Updated: 2023/02/28 01:15:47 by wonjilee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cmd->num[0] == 1)
		local_abot_num0(data, a, b, cmd);
	else if (cmd->num[1] == 1)
		local_abot_num1(data, a, b, cmd);
	else if (cmd->num[2] == 1)
		local_abot_num2(data, a, b, cmd);
	else if (cmd->num[3] == 1)
		local_abot_num3(data, a, b, cmd);
}
