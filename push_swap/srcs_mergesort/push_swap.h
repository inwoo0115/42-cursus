...
/*   Updated: 2023/03/19 22:31:41 by wonjilee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pass_tri_left2(t_info *data, t_stack *a, t_stack *b, int i);
void	pass_tri_left1(t_info *data, t_stack *a, t_stack *b, int next);

//merge_sort_init
void	merge_tri_init(t_info *data, t_stack *a, t_stack *b);
